			...
			<?php include("include/header.php");?>	
                ...
                <div class="innermain" style="width:880px;">
                        <div class="mainsection"> 
                                  <p class="discussheader"> <a  href="http://localhost/Attendence/index.php/toforumview"> 
                      Discussion Centre</a></p>
                        </div>
                        <div class="topic">
                        <p class="skills"> Post Your Question </p>
                        <?php  
						$this->load->library('Form_validation');
						echo validation_errors();
						echo form_open('http://localhost/Attendence/index.php/postquestion/postphp');
						?>
