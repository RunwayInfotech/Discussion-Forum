		...
		<div class="container">		
			<div class="innermain">						
				<?php 
					...
					{ 
					?>
				<input type="button" value="New Registration" onClick="window.location.href='registration.php'">
				<input type="button" value="Remove Employee Details" onClick="window.location.href='remove.php'">
				<?php 
					} 
				?>
				...
				<input type="button" value="Sign Out" onClick="window.location.href='signOut.php'">
				<br/>
				<div style="float:left; margin-left:35px;" id="password"  class = "active">
